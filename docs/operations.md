...
`parity-gfx-texture-lab` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for texture systems, covering storage recovery, log and snapshot fixtures, and failure-oriented tests.
