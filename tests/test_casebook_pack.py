"""Regression checks for the parity-gfx-texture-lab casebook."""
...
from casebook.harness import assert_expected, parity_gfx_texture_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(parity_gfx_texture_lab_summary(), assert_expected())
